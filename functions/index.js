                            ...
                            width: 100%;" width="100%">
                              <tr>
                                ...
                                valign="top">
                                  ...
                                  our study! Just a reminder that all 
                                  ...
                                  the app, please watch the video below.
                                  </p>
                                          ...
                                          width: auto;">
                                            <tbody>
                                              <tr>
                                                ...
                                                <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; border-radius: 5px; text-align: center; background-color: #3498db;" valign="top" align="center" bgcolor="#3498db"> <a href="https://youtu.be/qZrA7FmiVis" target="_blank" style="border: solid 1px #3498db; border-radius: 5px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-decoration: none; text-transform: capitalize; background-color: #ff8906; border-color: none; color: #ffffff;">Watch A Tutorial</a> </td>
                                              </tr>
                                            </tbody>
                                          </table>
                                        </td>
        ...
        userData.forEach(async (user) => {
          ...
          admin
              ...
              .add({
                to: user.email.toString(),
                message: {
                  subject: "Reminder to complete your daily tasks!",
                  html: `<!doctype html>
                  <html>
                    <head>
                      <meta name="viewport" 
                                    ...
                                    width: 100%;" width="100%">
                                      <tr>
                                        ...
                                        valign="top">
                                          ...
                                          <p> 
                                          Thank you for participating in 
                                          our study! This is just a reminder 
                                          to log into the application everyday 
                                          to check off your tasks! The trial 
                                          lasts until the 7th of July.</p> 
                                          <p>Just a reminder that all 
                                          of the data you submitted is 
                                          100% confidential and will not 
                                          be shared with anyone, not even 
                                          the researchers. Upon the 
